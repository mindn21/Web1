...
#? Record
#? ----------------------------------------------------------------
#? 24.11.07 몰명 변경사항 없데이트
#? 24.11.07 출고 이상인 것과, 몰명이상인것 중복되지 않도록 수정. 
#? 
...
def out(df):
    ...
    mall_list = ['밀크런', '스마트스토어', 'Cafe24(신) 유튜브쇼핑', '쿠팡', '아임웹', '카카오톡선물하기', '신세계몰(신)', '고도몰5', 
    ...
    # 여기서 df_condition_true 안에서 발르는 이유는, 위 "출고타입 이상"의 리스트와 중복이 없게 하기 위함임
    df_mall_problem = df_condition_true[~df_condition_true['몰명'].isin(mall_list)].copy()
